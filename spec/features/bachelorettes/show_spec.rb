...
RSpec.describe 'Bachelorette show' do
  before :each do
    @white = Bachelorette.create!(name: "Megan White", season_number: 1)
    @brown = Bachelorette.create!(name: "Hannah Brown", season_number: 2)
  ...
  xit "has bachelorette's name, season number, and season description" do\
    ...
    expect(current_path).to be("/bachelorettes/#{@brown.id}/contestants")
